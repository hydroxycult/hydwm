...
static const char *tagicon_selected = "󰮯"; 
static const char *tagicon_occupied = ""; 
static const char *tagicon_empty    = "";
...
static const Key keys[] = {
	...
	{ ControlMask|ShiftMask,        XK_bracketright,       spawn,          SHCMD("$HOME/boomer/boomer") },                    // tsoding's boomer zoomer 
